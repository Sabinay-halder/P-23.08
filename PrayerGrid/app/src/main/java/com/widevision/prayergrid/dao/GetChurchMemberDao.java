 ...
 */
public class GetChurchMemberDao extends QueryManager<GsonClass> {

    String user_id, cid;

    public GetChurchMemberDao(String user_id, String cid) {
        this.user_id = user_id;
        this.cid = cid;
/*mainTag: getChurchMember (user_id, cid)*/
    }
