...
public class MinistryListFragment extends Fragment {
    ...
    public MinistryListFragment() {
        // Required empty public constructor
    }

    public static MinistryListFragment newInstance() {
        MinistryListFragment fragment = new MinistryListFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        init(view);
        title.setText("List of Ministry");
        return view;
    }
                ...
                public void onOperationCompleted(GsonClass result, Exception e) {
                    ...
                    if (e == null && result != null) {
                        if (result.success.equals("1")) {
                            ...
                            Constant.setAlert(getActivity(), "There is no ministry group to show.");
                        }
                    } else {
