...
public class ChurchPrayerpostFragment extends HideKeyFragment implements Validator.ValidationListener {
    ...
    public ChurchPrayerpostFragment() {
        // Required empty public constructor
    }

    public static ChurchPrayerpostFragment newInstance(String type, String id) {
        ChurchPrayerpostFragment fragment = new ChurchPrayerpostFragment();
        Bundle b = new Bundle();
    ...
    public static ChurchPrayerpostFragment newInstance(String type) {
        ChurchPrayerpostFragment fragment = new ChurchPrayerpostFragment();
        Bundle b = new Bundle();
        b.putString("type", type);
        fragment.setArguments(b);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (type.equals("0")) {
            ...
            mPrayEdt.setHint("Post your answerd prayer here!");
        }
