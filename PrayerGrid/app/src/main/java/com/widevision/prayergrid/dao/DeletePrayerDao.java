 ...
 */
public class DeletePrayerDao extends QueryManager<GsonClass> {


    String user_id, pid;

    public DeletePrayerDao(String user_id, String pid) {

        this.user_id = user_id;
        this.pid = pid;
/*DeletePrayer
Main tag: setDeletePrayer
(user_id,pid)*/
    }
