 ...
 */
public class GetPrayerListDao extends QueryManager<GsonClass> {

    String user_id, category, pageCount, country;

    public GetPrayerListDao(String user_id, String category, String pageCount, String country) {
