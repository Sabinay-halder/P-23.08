...
public class WorkplaceListFragment extends Fragment {
    ...
    public static WorkplaceListFragment newInstance() {
        WorkplaceListFragment fragment = new WorkplaceListFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        init(view);
        title.setText("List of Workplace");
        return view;
    }
