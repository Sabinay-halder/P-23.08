 ...
 */
public class DeleteCommentDao extends QueryManager<GsonClass> {


    String user_id, cid;

    public DeleteCommentDao(String user_id, String cid) {

        this.user_id = user_id;
        this.cid = cid;
/*Delete Comments
Main tag:setDeleteComments
(user_id,cid)*/
    }
